...
package net.mcreator.randommod.world.dimension;
...
public class MorbinTimeDimension {
	@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
	public static class Fixers {
		@SubscribeEvent
		public static void registerFillerBlocks(FMLCommonSetupEvent event) {
			Set<Block> replaceableBlocks = new HashSet<>();
			replaceableBlocks.add(RandomModModBlocks.MORBIN_BLOCK.get());
			replaceableBlocks.add(RandomModModBlocks.MORBIN_BLOCK.get());
			replaceableBlocks.add(RandomModModBlocks.MORBIN_BLOCK.get());
			event.enqueueWork(() -> {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("random_mod:morbin_time"), customEffect));
		}
	}
}
