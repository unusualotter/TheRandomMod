...
import net.mcreator.randommod.block.MorbinTimePortalBlock;
...
public class RandomModModBlocks {
	...
	public static final RegistryObject<Block> MORBIN_TIME_PORTAL = REGISTRY.register("morbin_time_portal", () -> new MorbinTimePortalBlock());
}
